...
//CharSequence는 자바에서 만든 인터페이스. 어떻게 동작하는지 예시를 보겠습니다.
public class B18CharSequenceTest {
    public static void main(String[] args) {
        ...
        System.out.println("CharSequence 타입을 인자로하는 메소드 확인");
        ...
        System.out.println("결론: 메소드 인자가 인터페이스 타입일때에는 여러가지 구현 클래스가 인자로 전달될 수 있음");
    }
}
